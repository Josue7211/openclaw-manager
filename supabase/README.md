...
ClawControl uses a self-hosted Supabase instance (via Docker Compose) as its primary database. This guide walks through getting Supabase running and connected to the app.
