...
### Navigation
- [ ] All 11 sections listed in left panel (Agent, Gateway, ClawControl, User, Connections, Display, Keybindings, Modules, Notifications, Account & Security, Data & Backup)
