# clawctrl — iOS Quick Capture Shortcut

Capture tasks, ideas, and notes from anywhere on your iPhone and send them straight into clawctrl.

---

## Prerequisites

- clawctrl running and reachable at `http://<your-server-ip>:3000` (or your server IP)
...
Add this to `/path/to/clawctrl/.env.local`:
...
3. Check clawctrl → the item should appear in your Todos
