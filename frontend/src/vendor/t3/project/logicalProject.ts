// Copied/adapted from T3 Code apps/web/src/logicalProject.ts.
// Upstream behavior: repository identity wins; repository-path can split
// subroots; separate mode scopes by environment/path.
...
export function deriveProjectGroupingOverrideKey(project: Pick<Project, 'environmentId' | 'cwd'>): string {
