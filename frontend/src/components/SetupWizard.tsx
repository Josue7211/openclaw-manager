  ...
  const handleCompletion = useCallback(async () => {
    ...
    try {
      ...
      const serviceCredentials: ServiceCredentialsEntry[] = [
        ...
        { service: 'hermes', keychainKey: 'hermes.api-url', value: wizard.harnessUrl },
        { service: 'hermes', keychainKey: 'hermes.api-key', value: wizard.harnessApiKey },
        { service: 'hermes-dashboard', keychainKey: 'hermes.dashboard-api-url', value: wizard.codexLbUrl },
        { service: 'hermes-dashboard', keychainKey: 'hermes.dashboard-password', value: wizard.codexLbDashboardPassword },
        { service: 'codex-lb', keychainKey: 'codex-lb.api-url', value: wizard.codexLbUrl },
        { service: 'codex-lb', keychainKey: 'codex-lb.dashboard-password', value: wizard.codexLbDashboardPassword },
