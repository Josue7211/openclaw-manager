      ...
      <div style={row}>
        <div>
          ...
          <div style={{ fontSize: '11px', color: 'var(--text-muted)', marginTop: '2px', maxWidth: '340px', lineHeight: 1.5 }}>
            Send anonymized error reports to help improve clawctrl. No personal data, messages, or credentials are ever included.
          </div>
        </div>
        ...
        <Button
          ...
          onClick={async () => {
            ...
            try {
              ...
              downloadBlob(blob, `clawctrl-data-${new Date().toISOString().slice(0, 10)}.json`)
            } catch (err) {
        ...
        <Button
          ...
          onClick={async () => {
            ...
            try {
              ...
              downloadBlob(blob, `clawctrl-backup-${new Date().toISOString().slice(0, 10)}.sqlite`)
            } catch (err) {
        ...
        <Button
          ...
          onClick={async () => {
            ...
            try {
              ...
              downloadBlob(blob, `clawctrl-notes-${new Date().toISOString().slice(0, 10)}.json`)
            } catch (err) {
