...
function NodeContent({ data, node, tab, onSelect }: { data: HomelabData; node: NodeInfo; tab: string; onSelect: (id: string) => void }) {
  ...
  if (tab !== 'Summary') return <Placeholder title={tab} text={`Parity gap: ${tab} data/actions are not implemented in ClawControl yet.`} />
