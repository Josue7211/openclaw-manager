/**
 * Sandbox HTML builder for generated module previews.
 */
...
${componentSource}
  ...
  // Render: call GeneratedWidget if defined
  if (typeof GeneratedWidget === 'function') {
    var props = { widgetId: 'preview', config: {}, isEditMode: false, size: { w: 4, h: 3 } }
    var result = GeneratedWidget(props, h)
