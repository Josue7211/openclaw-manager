...
export const BUILTIN_WIDGETS: WidgetDefinition[] = [
  {
    ...
    defaultSize: { w: 1, h: 2 },
    minSize: { w: 1, h: 2 },
    component: () => import('@/features/dashboard/widgets/AgentStatusCard').then(m => ({ default: m.AgentStatusCard })),
  },
  {
    id: 'heartbeat',
    name: 'Heartbeat',
    ...
    defaultSize: { w: 1, h: 2 },
    minSize: { w: 1, h: 2 },
    component: () => import('@/features/dashboard/widgets/HeartbeatCard').then(m => ({ default: m.HeartbeatCard })),
  },
  {
    id: 'agents',
    name: 'Agents',
    ...
    defaultSize: { w: 2, h: 3 },
    minSize: { w: 2, h: 2 },
    component: () => import('@/features/dashboard/widgets/AgentsCard').then(m => ({ default: m.AgentsCard })),
  },
  {
    id: 'missions',
    name: 'Missions',
    ...
    defaultSize: { w: 2, h: 3 },
    minSize: { w: 2, h: 2 },
    component: () => import('@/features/dashboard/widgets/MissionsCard').then(m => ({ default: m.MissionsCard })),
  },
  {
    id: 'memory',
    name: 'Memory',
    ...
    defaultSize: { w: 1, h: 2 },
    minSize: { w: 1, h: 2 },
    component: () => import('@/features/dashboard/widgets/MemoryCard').then(m => ({ default: m.MemoryCard })),
  },
  {
    id: 'idea-briefing',
    name: 'Idea Briefing',
    ...
    defaultSize: { w: 2, h: 2 },
    minSize: { w: 1, h: 2 },
    component: () => import('@/features/dashboard/widgets/IdeaBriefingCard').then(m => ({ default: m.IdeaBriefingCard })),
  },
  {
    id: 'network',
    name: 'Network',
    ...
    defaultSize: { w: 1, h: 2 },
    minSize: { w: 1, h: 2 },
    component: () => import('@/features/dashboard/widgets/NetworkCard').then(m => ({ default: m.NetworkCard })),
  },
  {
    id: 'sessions',
    name: 'Sessions',
    ...
    defaultSize: { w: 1, h: 2 },
    minSize: { w: 1, h: 2 },
    component: () => import('@/features/dashboard/widgets/SessionsCard').then(m => ({ default: m.SessionsCard })),
  },
  {
    id: 'todos',
    name: 'Todos',
  ...
  },
  {
    ...
    description: 'Active Hermes Agent sessions overview',
    icon: 'Robot',
    category: 'ai',
    tier: 'builtin',
    defaultSize: { w: 3, h: 3 },
    minSize: { w: 2, h: 2 },
    component: () => import('@/components/widgets/HermesSessionsWidget').then(m => ({ default: m.HermesSessionsWidget })),
  },
  {
    id: 'vnc-viewer',
    name: 'Remote Viewer',
    description: 'Hermes Agent remote desktop preview',
    icon: 'Monitor',
    category: 'ai',
    tier: 'builtin',
    defaultSize: { w: 3, h: 3 },
