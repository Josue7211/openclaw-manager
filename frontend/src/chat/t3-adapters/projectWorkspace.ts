 ...
 * clawctrl keeps product-specific persistence here so Chat.tsx only wires
...
export function terminalProjectEnv({
  ...
  return {
    ...
    CLAWCTRL_PROJECT_ID: generic.CHAT_PROJECT_ID,
    CLAWCTRL_SESSION_KEY: generic.CHAT_SESSION_KEY,
    CLAWCTRL_PROJECT_PATH: generic.CHAT_PROJECT_PATH,
    CLAWCTRL_PROJECT_ROOT: generic.CHAT_PROJECT_ROOT,
    CLAWCTRL_PROJECT_NAME: generic.CHAT_PROJECT_NAME,
    CLAWCTRL_ENVIRONMENT_ID: generic.CHAT_ENVIRONMENT_ID,
    CLAWCTRL_RUNTIME: generic.CHAT_RUNTIME,
    CLAWCTRL_BRANCH: generic.CHAT_BRANCH,
    CLAWCTRL_WORKSPACE_CWD: generic.CHAT_WORKSPACE_CWD,
    CLAWCTRL_WORKING_DIR: generic.CHAT_WORKING_DIR,
    CLAWCTRL_TERMINAL_CWD: generic.CHAT_TERMINAL_CWD,
    CLAWCTRL_REPOSITORY_ROOT: generic.CHAT_REPOSITORY_ROOT,
  }
}
