...
This directory contains the memd configuration for `clawctrl`.

## Quick Start

1. Set up the bundle:
   - `memd setup --output /run/media/josue/T7/projects/clawctrl/.memd`
2. Check readiness and repair drift when needed:
   - `memd doctor --output /run/media/josue/T7/projects/clawctrl/.memd`
   - `memd doctor --output /run/media/josue/T7/projects/clawctrl/.memd --repair`
3. Inspect the active config:
   - `memd config --output /run/media/josue/T7/projects/clawctrl/.memd`
4. Refresh the live wake-up surface:
   - `memd wake --output /run/media/josue/T7/projects/clawctrl/.memd --route auto --intent current_task --write`
...
6. Inspect the compact working-memory view when needed:
   - `memd resume --output /run/media/josue/T7/projects/clawctrl/.memd --route auto --intent current_task`
7. Before memory-dependent answers, run bundle-aware recall:
   - `memd lookup --output /run/media/josue/T7/projects/clawctrl/.memd --query "..."`

## Commands

- `memd commands --output /run/media/josue/T7/projects/clawctrl/.memd`
- `memd commands --output /run/media/josue/T7/projects/clawctrl/.memd --summary`
- `memd commands --output /run/media/josue/T7/projects/clawctrl/.memd --json`
- `memd setup --output /run/media/josue/T7/projects/clawctrl/.memd`
- `memd doctor --output /run/media/josue/T7/projects/clawctrl/.memd`
- `memd config --output /run/media/josue/T7/projects/clawctrl/.memd`
...
- For Codex, start from `.memd/wake.md`, then use `memd lookup --output /run/media/josue/T7/projects/clawctrl/.memd --query "..."` before memory-dependent answers.
